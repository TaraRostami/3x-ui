...
```
bash <(curl -Ls https://raw.githubusercontent.com/tararostami/3x-ui/master/install.sh) v2.3.0
```
...
[![Stargazers over time](https://starchart.cc/TaraRostami/3x-ui.svg)](https://starchart.cc/TaraRostami/3x-ui)
